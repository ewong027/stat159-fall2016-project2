...
#Analysis
The right M was chosen based off the MSE, the mean squared error. The *MSEP Plot of Partial Least Squares* plot shows the relationship between MSEP (mean squared error of predictions) and the number of components, M.
...
Then using the full dataset, we came up the ceofficients in 
