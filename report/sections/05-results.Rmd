...
ggplot(coef_melt, aes(type,value))+
  ...
  scale_fill_manual(values = c('#fe6f5e', '#ffcc33', '#afe313', '#95e0e8',
                               '#7070cc'))+
  ggtitle(label = 'Estimated Regression Coefficients Separated by Variable and Regression Type')
